        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-5 max-w-6xl">
          ...
          <div className="flex  flex-col space-y-6 flex-shrink-0">
            <img
              src="/logo/light.png"
              alt="Light bulb"
              className="mt-5 w-45 h-45"
            />
            <img
              src="/logo/thinking.png"
              alt="Thinking"
              className="w-45 h-45"
            />
          </div>
          ...
          <div className="bg-white shadow-md rounded-xl p-3 md:p-7 flex-1">
            <div className="text-gray-800 font-sans leading-relaxed text-base md:text-lg">
              <p className="mb-1 ">
                We believe going digital should be simple, fast, and
                stress-free. That’s why we’ve built an easy way for restaurants
                to create and share beautiful QR code menus — no apps, no tech
                skills, no hassle.
              </p>
              <p className="mb-1">
                With our platform, you can turn your menu into a digital
                experience in just minutes. Upload your menu, customize your
                colors and logo, and get a QR code that’s ready to print or
                share online. It’s that easy.
              </p>
              <p className="mb-1">
                Your customers will love it too. They can scan the QR code and
                view your menu instantly on their phone — contactless,
                convenient, and always up to date. No more outdated paper menus
                or reprints when prices change.
              </p>
              <p className="mb-1">
                You’ll save time, cut printing costs, and boost sales by giving
                your customers a smoother experience. Whether you run a small
                café or a busy restaurant, our system helps you look more
                professional and modern.
              </p>
              <p className="mb-1">
                Plus, you get insights that help your business grow — see how
                often your QR codes are scanned and understand what’s working
                best.
              </p>
              <p>
                Simple to set up, easy to manage, and designed to impress — we
                help you bring your menu into the digital age while keeping
                things effortless.
              </p>
            </div>
          </div>
