      ...
      return (
        <nav className="flex justify-between items-center px-8 py-4 bg-[#EFFFFF] shadow-sm">
          ...
          <div className="flex items-center gap-5">
            <a href="/login" className="hidden sm:inline-flex px-4 py-2 rounded-lg border border-black text-[#38b6ff] hover:bg-[#38b6ff]/10 transition w-[120px] items-center justify-center font-medium">
              Sign in
            </a>
            <a href="/page/rigester/getstart" className="inline-flex px-4 py-2 rounded-lg border border-[#38b6ff] bg-[#38b6ff] text-white hover:brightness-95 shadow-sm shadow-[#38b6ff]/30 transition w-[120px] items-center justify-center font-medium">
